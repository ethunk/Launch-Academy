...
twitter_data.each do |hash|
  hash.each do |key, value|
    puts "#{key}: #{value["number of followers"]}"
  end
end
puts "=========="
twitter_data.each do |hash|
  hash.each do |key, value|
    puts "#{key}'s latest tweet was #{value["last twenty tweets"][-1].length} characters long."
  end
end
...
twitter_data.each do |hash|
  hash.each do |key, value|
    tweets = value["last twenty tweets"]
    twitters = tweets.join("")
    puts "#{key} used #{twitters.length} characters in their last twenty tweets."
  end
end
...
twitter_data.each do |hash|
  hash.each do |key, value|
    if value["number of followers"] > number
      number = value["number of followers"]
      user = key
    end
  end
end

puts "#{user} has the most followers with #{number} followers"
...
twitter_data.each do |hash|
  hash.each do |key, value|
    if value["number of friends"] > number
      number = value["number of friends"]
      user = key
    end
  end
end

puts "#{user} has the most friends with #{number} friends"
...
twitter_data.each do |hash|
  hash.each do |key, value|
    if value["last twenty tweets"].length > number
      number = value["last twenty tweets"].length
      user = key
    end
  end
end

puts "#{user} has the greatest number of tweets with #{number} tweets"
